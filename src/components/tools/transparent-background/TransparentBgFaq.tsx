 ...
 *
 * FAQPage is the single owner of FAQ structured data; StructuredData component
 * owns SoftwareApplication + BreadcrumbList only.
 */
export function TransparentBgFaq() {
  ...
  return (
    <section
      aria-labelledby="transparent-bg-faq-heading"
    ...
    >
      ...
      />
      <h2 id="transparent-bg-faq-heading" className="font-display text-3xl font-bold text-text">
        {t('faq.title')}
      </h2>
