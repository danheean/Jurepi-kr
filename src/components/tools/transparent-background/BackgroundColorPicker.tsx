      ...
      <div className="flex items-end gap-4">
        <div className="flex-1 space-y-2">
          ...
          <input
            ...
            className="w-full rounded-md border border-hairline bg-surface px-3 py-2 text-sm font-mono text-text placeholder-text-muted focus:outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-offset-2"
            pattern="#[0-9A-Fa-f]{6}"
          />
        </div>
