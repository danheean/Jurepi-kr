          ...
          <>
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-black/0 to-black/20 flex items-center justify-center">
              <button
                ...
                className="flex items-center justify-center w-16 h-16 rounded-full bg-black/70 hover:bg-black/80 shadow-card hover:shadow-card-hover transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-focus-ring focus-visible:ring-offset-2 focus-visible:ring-offset-surface-muted"
