...
export function ClearButton({ onClick }: ClearButtonProps) {
  ...
  return (
    <button
      onClick={handleClick}
      className="inline-flex items-center justify-center gap-2 px-4 py-2 bg-surface-muted text-text rounded-lg font-medium hover:bg-surface-sunken transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-brand min-h-11 min-w-11"
