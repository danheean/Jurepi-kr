  ...
  return (
    ...
    >
      ...
      <input
        ...
        className="w-full px-4 py-2 rounded-lg border border-hairline focus-visible:border-brand-ink focus-visible:ring-3 focus-visible:ring-brand-soft focus:outline-none text-body transition-colors"
      />
