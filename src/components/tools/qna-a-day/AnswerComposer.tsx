  ...
  return (
    ...
    >
      <textarea
        ...
        maxLength={MAX_CHARS}
        className={`w-full min-h-[140px] p-4 rounded-lg border border-hairline focus-visible:border-brand-ink focus-visible:ring-3 focus-visible:ring-brand-soft focus:outline-none resize-none font-body text-base leading-relaxed transition-colors ${
