...
/**
 * SSR-safe FAQ + FAQPage JSON-LD (single owner per heuristic).
...
export function MyIpFaq() {
  ...
  return (
    <section
      aria-labelledby="my-ip-faq-heading"
    ...
    >
      ...
      />
      <h2 id="my-ip-faq-heading" className="font-display text-3xl font-bold text-text">
        {t('faq.title')}
      </h2>
