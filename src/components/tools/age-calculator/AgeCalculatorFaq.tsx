 ...
 */
export function AgeCalculatorFaq() {
  ...
  return (
    <section
      aria-labelledby="age-calculator-faq-heading"
    ...
    >
      ...
      />
      <h2 id="age-calculator-faq-heading" className="font-display text-3xl font-bold text-text">
        {t('faq.heading')}
      </h2>
