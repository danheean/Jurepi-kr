...
export const FIELD_ORDER = ['ai', 'programming', 'tech', 'games', 'movies', 'music', 'sports'] as const;
...
export const RankingFileFrontSchema = z.object({
  ...
  field: z.enum(['ai', 'programming', 'tech', 'games', 'movies', 'music', 'sports']).optional(),
...
export const MergedRankingSchema = z.object({
  ...
  field: z.enum(['ai', 'programming', 'tech', 'games', 'movies', 'music', 'sports']),
